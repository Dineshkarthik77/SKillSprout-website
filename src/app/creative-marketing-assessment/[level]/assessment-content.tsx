...
export function CreativeMarketingAssessmentContent({ level }: { level: number }) {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      ...
      try {
        const result = await generateQuiz({ domain: 'Creative & Marketing', level });
        setQuizData(result);
        setPageState('loaded');
      } catch (error) {
    ...
    return (
      <div className="flex flex-col items-center justify-center text-center h-96">
        ...
        <h2 className="text-2xl font-headline font-semibold">
          Generating Your Creative & Marketing Assessment...
        </h2>
